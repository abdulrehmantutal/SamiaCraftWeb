...
namespace samiacraft.Models.BLL
{
    ...
    //        }
    //    }
    //    public List<navigationBLL> GetSubCategoryMobile()
    //    {
    //        try
    //        {
    //            List<navigationBLL> Categories = new List<navigationBLL>();
    ...
    public class navigationBLL
    {
        ...
        public List<navigationBLL> GetSubCategory(int LocationId)
        {
            try
            {
                List<navigationBLL> Categories = new List<navigationBLL>();
                ...
                _ds = (new DBHelper().GetDatasetFromSP)("sp_Navigation_SamiaCraft", p);
                if (_ds != null)
                {
                    if (_ds.Tables.Count > 0)
                    {
