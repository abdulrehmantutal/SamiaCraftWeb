    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (_notificationls == '' && lstNotification.length > 0) {
                ...
                $('#modalImg').attr('src',"https://premiumposuat-001-site8.mtempurl.com/"+ lstNotification[index].Image)
            }
        },
...
function topheadcart() {
    ...
    for (var i = 0; i < data.length; i++) {
        ...
        if (data[i].Image == "" || data[i].Image == null) {
            ...
            html += '<a href="/Product/ProductDetails?ItemID=' + data[i].ItemID + '"><img alt="" src="https://premiumposuat-001-site8.mtempurl.com/' + data[i].Image + '"></a>'
        }
        html += '</div>'
...
function cartitem() {
    ...
    for (var i = 0; i < data.length; i++) {
        ...
        if (data[i].Image == "" || data[i].Image == null) {
            ...
            html += '<td class="plantmore-product-thumbnail"><a href="/Product/ProductDetails?ItemID=' + data[i].ItemID + '"><img class="cart-img" src="https://premiumposuat-001-site8.mtempurl.com/' + data[i].Image + '" alt=""></a></td>'
        }
        ...
        if (gifts.length > 0) {
            ...
            for (var j = 0; j < _dataGiftFilter.length; j++) {
                ...
                html += '<div class="d-flex flex-wrap justify-content-center mb-3 gift-in-cart border">'
                    + '<div class="p-2 img"><img src="https://premiumposuat-001-site8.mtempurl.com/' + _dataGiftFilter[j].Image + '" alt=""></div>'
